"""
Django settings for HemAuctionSystem project.
...
SECRET_KEY = 'w@bfk**56mz6f4%w6avw3-ya&(xce#ccf)))1^ty4(gs+9-_9-'
...
WSGI_APPLICATION = 'HemAuctionSystem.wsgi.application'
